...
@section('content')
        <div class="row">
            <div class="col-md-6">
                <div class="card mb-4">
                    <h5 class="card-header">Tambah Data Sensor Tekanan</h5>
                    <div class="card-body">
                        <form action="{{url('tambah-sensor-tekanan')}}" method="post">
                            @csrf
                            <div class="mb-1">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="keterangan" class="form-control" placeholder="Detail Tempat Sensor" required/>
                            </div>
                            <div class="float-end">
